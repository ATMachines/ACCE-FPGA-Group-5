...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("p_ground_address1", 12, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("p_ground_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("p_ground_q1", 32, hls_in, 0, "ap_memory", "MemPortDOUT2", 1),
	...
	Port_Property("p_clouds_address1", 3, hls_out, 4, "ap_memory", "MemPortADDR2", 1),
	Port_Property("p_clouds_ce1", 1, hls_out, 4, "ap_memory", "MemPortCE2", 1),
	Port_Property("p_clouds_q1", 224, hls_in, 4, "ap_memory", "MemPortDOUT2", 1),
