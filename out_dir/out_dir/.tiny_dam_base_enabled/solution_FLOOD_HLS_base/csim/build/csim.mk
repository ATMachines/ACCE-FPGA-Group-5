...
$(ObjDir)/test_FLOOD_base.o: ../../../../test_FLOOD_base.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DNROWS=50 -DNCOLS=50 -DNCLOUDS=7 -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \
...
$(ObjDir)/flood_HLS_base.o: ../../../../flood_HLS_base.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DNROWS=50 -DNCOLS=50 -DNCLOUDS=7  $(IFLAG) $(DFLAG) $< -o $@ ; \
