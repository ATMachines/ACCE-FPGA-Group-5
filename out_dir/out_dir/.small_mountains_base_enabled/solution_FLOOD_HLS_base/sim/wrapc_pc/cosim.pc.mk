...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /cm/shared/package/vivado/Vitis_HLS/2024.1/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/cm/shared/package/vivado/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/test_FLOOD_base.cpp_pre.cpp.tb.o : test_FLOOD_base.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_FLOOD_base.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/flood_HLS_base.cpp_pre.cpp.tb.o : flood_HLS_base.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling flood_HLS_base.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/rng.cpp_pre.cpp.tb.o : rng.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling rng.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
