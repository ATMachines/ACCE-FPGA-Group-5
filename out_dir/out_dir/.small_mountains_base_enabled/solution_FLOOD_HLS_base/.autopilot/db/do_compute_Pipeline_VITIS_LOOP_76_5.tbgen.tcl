set moduleName do_compute_Pipeline_VITIS_LOOP_76_5
set isTopModule 0
...
set C_modelName {do_compute_Pipeline_VITIS_LOOP_76_5}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict p_clouds { MEM_WIDTH 224 MEM_SIZE 252 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ p_clouds int 224 regular {array 9 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ p_clouds_address0 sc_out sc_lv 4 signal 0 } 
	{ p_clouds_ce0 sc_out sc_logic 1 signal 0 } 
	{ p_clouds_we0 sc_out sc_logic 1 signal 0 } 
	{ p_clouds_d0 sc_out sc_lv 224 signal 0 } 
	{ p_clouds_address1 sc_out sc_lv 4 signal 0 } 
	{ p_clouds_ce1 sc_out sc_logic 1 signal 0 } 
	{ p_clouds_q1 sc_in sc_lv 224 signal 0 } 
...
set Spec2ImplPortList { 
	p_clouds { ap_memory {  { p_clouds_address0 mem_address 1 4 }  { p_clouds_ce0 mem_ce 1 1 }  { p_clouds_we0 mem_we 1 1 }  { p_clouds_d0 mem_din 1 224 }  { p_clouds_address1 MemPortADDR2 1 4 }  { p_clouds_ce1 MemPortCE2 1 1 }  { p_clouds_q1 MemPortDOUT2 0 224 } } }
}
