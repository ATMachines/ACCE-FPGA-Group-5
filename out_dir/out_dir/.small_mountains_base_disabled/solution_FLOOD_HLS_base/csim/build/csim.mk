...
$(ObjDir)/test_FLOOD_base.o: ../../../../test_FLOOD_base.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DNROWS=60 -DNCOLS=80 -DNCLOUDS=9 -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \
...
$(ObjDir)/flood_HLS_base.o: ../../../../flood_HLS_base.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DNROWS=60 -DNCOLS=80 -DNCLOUDS=9  $(IFLAG) $(DFLAG) $< -o $@ ; \
