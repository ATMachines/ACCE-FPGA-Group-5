...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /cm/shared/package/vivado/Vitis_HLS/2024.1/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /cm/shared/package/vivado/Vitis_HLS/2024.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /cm/shared/package/vivado/Vitis_HLS/2024.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /cm/shared/package/vivado/Vitis_HLS/2024.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /cm/shared/package/vivado/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /cm/shared/package/vivado/Vitis_HLS/2024.1/lib/lnx64.o/Default:$::env(LD_LIBRARY_PATH)
...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe small_mountains.out M 0.00001 100 50 10 20 12 110 9 2 110 20 45 843135 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "do_compute.autotvin.dat"
	set constFileTvOut       "do_compute.autotvout.dat"
	set constFileHdlTvIn     "do_compute.autohdltvin.dat"
	set constFileHdlTvOut    "do_compute.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
